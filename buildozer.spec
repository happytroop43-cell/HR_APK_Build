...
# Crucial: No spaces after commas. Pinned to stable packages.
...
# (str) Android Build Tools version to use (CRITICAL FIX: Prevents breaking auto-pull of v37)
...
# (list) Architectures to build for (Covering all modern mobile devices)
